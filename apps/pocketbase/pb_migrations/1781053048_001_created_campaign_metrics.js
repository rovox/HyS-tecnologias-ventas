...
migrate((app) => {
  const collection = new Collection({
    ...
    "system": false,
    "type": "base",
    "updateRule": "@request.auth.role = 'VENTAS / ADMINISTRACI\u00d3N' || @request.auth.role = 'ADMINISTRADOR'",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_7614396699");
